...
Examples/Monocular/CMakeFiles/mono_tum.dir/mono_tum.cc.o: ../Examples/Monocular/mono_tum.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/lzb/G-ORBSLAM/my-orbslam2/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object Examples/Monocular/CMakeFiles/mono_tum.dir/mono_tum.cc.o"
	cd /home/lzb/G-ORBSLAM/my-orbslam2/build/Examples/Monocular && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/mono_tum.dir/mono_tum.cc.o -c /home/lzb/G-ORBSLAM/my-orbslam2/Examples/Monocular/mono_tum.cc
...
Examples/Monocular/CMakeFiles/mono_tum.dir/mono_tum.cc.i: cmake_force
	...
	cd /home/lzb/G-ORBSLAM/my-orbslam2/build/Examples/Monocular && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/lzb/G-ORBSLAM/my-orbslam2/Examples/Monocular/mono_tum.cc > CMakeFiles/mono_tum.dir/mono_tum.cc.i
...
Examples/Monocular/CMakeFiles/mono_tum.dir/mono_tum.cc.s: cmake_force
	...
	cd /home/lzb/G-ORBSLAM/my-orbslam2/build/Examples/Monocular && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/lzb/G-ORBSLAM/my-orbslam2/Examples/Monocular/mono_tum.cc -o CMakeFiles/mono_tum.dir/mono_tum.cc.s
...
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_shape.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_stitching.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_superres.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_videostab.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_viz.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_objdetect.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_calib3d.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_features2d.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_flann.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_highgui.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_ml.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_photo.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_video.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_videoio.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_imgcodecs.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_imgproc.so.3.2.0
../bin/examples/monocular/mono_tum: /usr/local/lib/libopencv_core.so.3.2.0
...
../bin/examples/monocular/mono_tum: Examples/Monocular/CMakeFiles/mono_tum.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/lzb/G-ORBSLAM/my-orbslam2/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../../bin/examples/monocular/mono_tum"
	cd /home/lzb/G-ORBSLAM/my-orbslam2/build/Examples/Monocular && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/mono_tum.dir/link.txt --verbose=$(VERBOSE)
